...
const valor_snack = parseInt(prompt('cuál es el valor de tu snack favorito'))
const semanas = 56
const snack_dia = 3
const total_snack = (snack_dia * semanas) * edad_max
const snack_faltan = total_snack - ((snack_dia * semanas) * edad)

alert('Necesitarás ' + snack_faltan + ' ' + snack + ' para que te alcancen hasta los ' + edad_max + ' años.')

alert('vas a gastar ' + valor_snack * snack_faltan + ' en ' + snack + ' el resto de tu vida. ')
